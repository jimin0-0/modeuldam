  ...
  return (
    <div className="tab-shipping">
      ...
      <div className='shipping-box'>
        <p className='shipping-title'>PAYMENT INFO</p>
      ...
      <p className='shipping-title'>DELIVERY INFO</p>
      <p className='shipping-txt'>
        배송 방법 : 택배 / 배송 지역 : 전국지역 / 배송 비용 : 무료 / 배송 기간 : 1일 ~ 4일<br />
        배송 안내 : 산간벽지나 도서지방은 별도의 추가금액을 지불하셔야 하는 경우가 있습니다. 고객님께서 주문하신 상품은 입금 확인후 배송해 드립니다.
      </p>
      <p className='shipping-txt'>다만, 상품종류에 따라서 상품의 배송이 다소 지연될 수 있습니다.</p>

      <p className='shipping-title'>EXCHANGE INFO</p>

      <div className='shipping-wrap'>
        <p className='shipping-sub'>교환 및 반품이 가능한 경우</p>
        <p className='shipping-txt'>
        ...
        <p className='shipping-sub'>교환 및 반품이 불가능한 경우</p>
        <p className='shipping-txt'>
