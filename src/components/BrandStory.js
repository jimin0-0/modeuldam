        ...
        <>
            ...
            <div className="brandstory-bg">
                <div className="brandstory-container">
                    <section>
                        <img src={process.env.PUBLIC_URL + "/images/brandstory1.jpg"} alt="브랜드스토리 이미지 1" />
                    ...
                    <section>
                        <img src={process.env.PUBLIC_URL + "/images/brand.png"} alt="브랜드스토리 이미지 2" />
                    ...
                    <section>
                        <img src={process.env.PUBLIC_URL + "/images/brandstory3.jpg"} alt="브랜드스토리 이미지 3" />
